...
export const ExternalProviderLinkVerifyScalarFieldEnumSchema = z.enum([
  'id',
  'provider',
...
export type ExternalProviderLinkVerify = z.infer<
  typeof ExternalProviderLinkVerifySchema
>;
